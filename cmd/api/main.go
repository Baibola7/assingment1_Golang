...
import (
	...
	"github.com/Baibola7/assingment1_Golang/internal/data"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:1234@localhost:5432/b.karsybaiDB?sslmode=disable", "PostgreSQL DSN")
